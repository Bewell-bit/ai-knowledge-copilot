...
export interface LlmClient {
  stream(messages: ChatMessage[], context: Citation[], signal?: AbortSignal): AsyncGenerator<string>;
  complete(messages: ChatMessage[], context: Citation[], signal?: AbortSignal): Promise<string>;
}
...
class DemoLlm implements LlmClient {
  ...
  async *stream(messages: ChatMessage[], context: Citation[], signal?: AbortSignal) {
